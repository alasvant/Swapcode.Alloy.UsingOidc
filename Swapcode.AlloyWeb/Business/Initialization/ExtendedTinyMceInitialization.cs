using Swapcode.AlloyWeb.Models.Blocks;
using Swapcode.AlloyWeb.Models.Pages;
using EPiServer.Cms.TinyMce.Core;
using EPiServer.Framework;
using EPiServer.Framework.Initialization;
using EPiServer.ServiceLocation;

namespace Swapcode.AlloyWeb.Business.Initialization
{
        ...
        public void ConfigureContainer(ServiceConfigurationContext context)
        {
            context.Services.Configure<TinyMceConfiguration>(config =>
            {
                ...
                config.For<EditorialBlock>(t => t.MainBody, config.Empty())
                    .AddPlugin(DefaultValues.EpiserverPlugins)
                    .DisableMenubar()
